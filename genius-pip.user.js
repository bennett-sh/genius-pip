...
// @downloadURL  https://github.com/bennett-sh/genius-pip/raw/main/genius-pip.user.js
// @grant        none
// ==/UserScript==
...
const piPInline = (() => {
    ...
    const lyrics = document.querySelector('[data-lyrics-container]')
    const lines = lyrics.innerHTML.split('\n').map(x => x.split('<br>')).flat(Infinity).map(x => parseLine(x)).join('\n').replaceAll('\n', '<br/>')
...
function createElement(type, options = {
  ...
  const element = target.createElement(type)

  ;(options.classes ?? []).forEach(c => element.classList.add(c))
  element.style = options.style ?? ''
  if(options.html) element.innerHTML = options.html ?? ''
  if(options.text) element.textContent += options.text ?? ''
  Object.entries(options.events ?? {}).forEach(([eventName, listeners]) => listeners.forEach(listener => element.addEventListener(eventName, listener)))
...
function createFocusButton(text = 'Focus') {
    return createButton(text, () => pip.window.focus())
}

function createPiPButton(text = 'PiP') {
    return createButton(text, async () => {
        if(pip) return exitPiP()

        await spawnPiP()
    })
}

function createPiPMessage() {
    return createElement('div', {
        ...
        children: [createElement('div', {
            ...
            `,
            children: [createFocusButton(), createPiPButton('Close')]
        })],
        classes: ['pip-message'],
        style: `
            font-size: 200%;
...
async function spawnPiP() {
    ...
    pip = await documentPictureInPicture.requestWindow({
        initialAspectRatio: (lyrics.clientWidth + convertRemToPixels(6)) / (lyrics.clientHeight - convertRemToPixels(6)),
...
@font-face {
  ...
  src: url(https://assets.genius.com/fonts/programme_bold.woff2?1676573542) format('woff2'),
    url(https://assets.genius.com/fonts/programme_bold.woff?1676573542) format('woff');
  font-style: normal;
  font-weight: bold;
}
...
@font-face {
  font-family: 'Programme';
  src: url(https://assets.genius.com/fonts/programme_normal.woff2?1676573542) format('woff2'),
    url(https://assets.genius.com/fonts/programme_normal.woff?1676573542) format('woff');
  font-style: normal;
  font-weight: normal;
}
...
@font-face {
  font-family: 'Programme';
  src: url(https://assets.genius.com/fonts/programme_normal_italic.woff2?1676573542) format('woff2'),
    url(https://assets.genius.com/fonts/programme_normal_italic.woff?1676573542) format('woff');
  font-style: italic;
  font-weight: normal;
}
...
@font-face {
  ...
  src: url(data:font/woff2;base64,) format('woff2'),
    url(https://assets.genius.com/fonts/programme_light.woff?1676573542) format('woff');
  font-style: normal;
  font-weight: 100;
}
...
@font-face {
  font-family: 'Programme';
  src: url(https://assets.genius.com/fonts/programme_light_italic.woff2?1676573542) format('woff2'),
    url(https://assets.genius.com/fonts/programme_light_italic.woff?1676573542) format('woff');
  font-style: italic;
  font-weight: 100;
}
...
.jvutUp, .jAzSMw {
    position: relative;
    padding: calc((1.5em - 1.125rem) / 2) 0px;
    scroll-margin: calc(max(10vw, 0px) + 3rem + 1.5em);
    text-decoration: none;
    color: inherit;
}

body {
    font: 100 1.125rem / 1.5 Programme, Arial, sans-serif !important;
    padding: 2rem;
}`
        })]
    }))
